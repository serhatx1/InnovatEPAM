...
| FR-01A | The system shall handle duplicate email registration attempts safely                                           | Duplicate signup attempts are blocked from creating a new account and the UI shows a generic non-enumerating message with guidance to sign in |
